...
//    public void voteComment(@RequestBody VoteComment voteComment) throws UserNotExist, CommentNotExist, InvalidVoteValue, SQLException {
//        if (voteComment.isVoteValid(voteComment.getVote())) {
//            if (CommentDAO.getComments(movieID).contains(voteComment.getCommentID())) {
